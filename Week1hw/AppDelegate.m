...
//  Week1hw
//
//  Created by Phurbu Dolma on 6/6/14.
...
{
    [[UINavigationBar appearance] setBarTintColor:UIColorFromRGB(0x1a71d2)];
    ...
    [[UINavigationBar appearance] setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:
                                                           ...
                                                           [UIFont fontWithName:@"Helvetica Neue Medium" size:21.0], NSFontAttributeName, nil]];
    ...
    SecondpViewController *secondViewController = [[SecondpViewController alloc] init];
    UINavigationController *secondNavigationController = [[UINavigationController alloc] initWithRootViewController:secondViewController];
    secondNavigationController.tabBarItem.title = @"Messages";
    secondNavigationController.tabBarItem.image = [UIImage imageNamed:@"messages"];
